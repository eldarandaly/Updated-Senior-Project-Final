...
class WelcomeScreen(QDialog):
    def __init__(self):
        ...
        self.create.clicked.connect(self.gotoAddADmin)
...
class NewEmployeeScreen(QDialog):
    def __init__(self):
        ...
        #self.gender=self.radioButton.selected()
    ...
    def DB(self):
        ...
        with sqlite3.connect(db_path) as db:
            ...
            cursor.execute("INSERT INTO Employees (Emp_First_Name, Emp_Middle_Name, Emp_Last_Name,Emp_Address,Emp_DOB) VALUES (?,?,?,?,?);",(self.firstname1,self.middlename1,self.lastname1,self.address,self.var_name))
           # for row in cursor.execute('SELECT Emp_ID FROM Employees where Emp_First_Name= ?;',(self.firstname1,)):
            #    print(row)
            if not cursor.fetchone(): #zabat de 
    ...
    def Caputer_Images(self):
        ...
        while True :
            ...
            if face_ext(frame) is not None:
                ...
                cv2.putText(face,str(count),(50,50),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,1,(255,0,0),3)
